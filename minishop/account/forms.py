...
class VendorRegistrationForm(forms.ModelForm):
    class Meta:
        model = Vendor
        fields = ['company_name', 'phone_number', 'email', 'address', 'description', 'logo']
        widgets = {
...
class VendorWarehouseForm(forms.ModelForm):
    class Meta:
        ...
        labels = {
            ...
            'city': 'Город',
            'address': 'Адрес',
            'is_default': 'Основной склад'
        }


class RegionDeliveryPriceForm(forms.ModelForm):
    class Meta:
        model = RegionDeliveryPrice
        fields = ['region_name', 'delivery_cost']
        widgets = {
